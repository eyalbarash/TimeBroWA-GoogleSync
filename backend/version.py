...
class VersionManager:
    ...
    def __init__(self):
        ...
        self.project_name = "WhatsApp Chat Storage System with Simple TimeBro Calendar"
    ...
    def get_version_info(self) -> dict:
        ...
        return {
            ...
            "build_number": 2,
            "features": [
                "Simple TimeBro Calendar System (No AI)",
                "Message grouping (10-minute intervals)",
                "RTL formatting for conversations",
                "Contact-based calendar filtering",
